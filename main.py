...
# Se va a extraer los prefijos de los nombre para despues agruparlos
prefixes = data['Name'].str.extract(r'([A-Za-z]+)\.')[0]
data['Prefix'] = prefixes

pd.crosstab(data['Prefix'], data['Sex'])

# Simplificar los prefijos
# prefix_replacements = {
#     'Capt': 'Mr', 'Col': 'Mr', 'Countess': 'Mrs', 'Don': 'Mr', 'Jonkheer': 'Mr',
#     'Lady': 'Mrs', 'Major': 'Mr', 'Mlle': 'Miss', 'Mme': 'Mrs', 'Ms': 'Mrs',
#     'Rev': 'Mr', 'Sir': 'Mr', 'Dr': 'Mr'
# }
# data['Prefix'] = data['Prefix'].replace(prefix_replacements)
